...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ClipboardHistoryStore", targets: ["ClipboardHistoryStore"]),
        .library(name: "QuickPaste", targets: ["QuickPaste"]),
    ...
    targets: [
        ...
        .target(name: "QuickPaste", dependencies: ["HotkeyEngine", "ClipboardHistoryStore"]),
        ...
        .testTarget(name: "PasteEngineTests", dependencies: ["PasteEngine", "ClipboardHistoryStore"]),
        .testTarget(name: "HistoryStoreTests", dependencies: ["HistoryStore"]),
        .testTarget(name: "ClipboardHistoryStoreTests", dependencies: ["ClipboardHistoryStore"]),
        .testTarget(name: "QuickPasteTests", dependencies: ["QuickPaste", "ClipboardHistoryStore", "HotkeyEngine"]),
        .testTarget(name: "KeychainStoreTests", dependencies: ["KeychainStore"]),
        .testTarget(name: "SettingsStoreTests", dependencies: ["SettingsStore", "QuickPaste"]),
